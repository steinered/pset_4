...
df %>% 
  ...
  kable(format = "html", escape = F, col.names = c("Indicators", "Chi-Squared Statistic", "Original P-value", "Bonferroni Adjusted P-value", "BH Adjusted P-value"), caption = "Indicators and Corresponding Significance") %>% 
