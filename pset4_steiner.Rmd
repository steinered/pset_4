...
The distribution of p-values is not normal; over half have a p-value \<
0.05. There are some indicators which fall across the rest of the
distribution, which may be indicative of some normal behavior; however,
the majority of "significant" predictors are likely noise.

*4. Construct Bonferroni p-values. Controlling the FWER at 5 percent,
which predictors are significant?*

The below table shows 25 indicators which have statistically significant Bonferroni-adjusted p-values.
```{r 4 part 1}
...
The below table shows 13 indicators which do not have statistically significant Bonferroni-adjusted p-values, despite having significant un-adjusted p-values.
